...
## EventInjectors: 
src/bin/infra/events/dispatcher.py 
src/bin/infra/events/listener.py
...
## Exchanges: 
src/bin/infra/exchanges/exchange.py
...
## TbtProcessor:
src/bin/markets/tbt_datafeed/processor.py
...
src/bin/markets/tbt_datafeed/tick_print_orderbook.py
...
## Instruments:
src/bin/markets/instruments.py
...
src/bin/markets/execution/basic_hit_strat.py
src/bin/markets/execution/exercise.py
